...
export default function AddQuestionCard({
  ...
  if (!open) {
    return (
      <button
        ...
        className="flex min-h-[9rem] w-full flex-col items-center justify-center gap-1 rounded-xl border-2 border-dashed border-slate-300 p-4 text-slate-400 transition hover:border-indigo-300 hover:text-indigo-500"
      >
  ...
  return (
    <div className="flex min-h-[9rem] w-full flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-indigo-300 bg-indigo-50/40 p-4">
